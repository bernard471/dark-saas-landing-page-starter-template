...
import { Bell, FileText, LayoutDashboard, Menu, Search, Settings, Users, Globe, PhoneForwarded, MailWarning, X } from "lucide-react"
...
import { PageTrackingTable } from "@/components/page-tracking-table"



export default function FakePageDetectionPage() {
  const [profileImage, setProfileImage] = useState<string | null>(null)
  const [pageToTrack, setPageToTrack] = useState("")
  const { trackedPages, refreshPages } = useTrackedPages();
  ...
  const handleTrackPage = async () => {
    try {
      const response = await axios.post("/api/pages/track", { page: pageToTrack })
      refreshPages() // Refresh the email list after tracking
      setPageToTrack("") // Clear the input
    } catch (error) {
    ...
    <div className="min-h-screen flex flex-col bg-gray-900 text-gray-100">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-6">
            <h2 className="text-2xl font-semibold mb-6">Fake Page Detection</h2>
            
            <Card className="bg-gray-800 border-gray-700 mb-6">
              <CardHeader>
                <CardTitle className="text-teal-200">Track new Phone number</CardTitle>
              </CardHeader>
              <CardContent>
              <div className="flex space-x-2">
                <Input 
                  ...
                  value={pageToTrack}
                  onChange={(e) => setPageToTrack(e.target.value)}
                />
                <Button 
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-teal-100">Recent Detections</CardTitle>
              </CardHeader>
              <CardContent>
        <PageTrackingTable pages={trackedPages} />
      </CardContent>
            </Card>
          </div>
        </main>
